  ...
  return (
    <TabsPrimitive.Tab
      ...
      className={cn(
        ...
        "data-active:border-primary/30 data-active:bg-primary/10 data-active:text-primary data-active:shadow-none dark:data-active:border-input dark:data-active:bg-input/30 dark:data-active:text-foreground dark:data-active:shadow-sm",
